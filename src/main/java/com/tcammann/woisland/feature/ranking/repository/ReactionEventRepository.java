package com.tcammann.woisland.feature.ranking.repository;
...
public interface ReactionEventRepository extends JpaRepository<ReactionEventEntity, Long> {
    ...
    @Query("select new com.tcammann.woisland.feature.ranking.model.Ranking(r.messageAuthor, count(r.messageAuthor)) " +
